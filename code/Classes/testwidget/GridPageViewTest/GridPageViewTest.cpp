...
bool CGridPageViewBackPackTest::init()
{
	...
	m_pLayout->setOnTouchMovedAfterLongClickListener(this, afterlongclick_selector(CGridPageViewBackPackTest::onLayoutTouchMovedAfterLongClick));
	m_pLayout->setOnTouchEndedAfterLongClickListener(this, afterlongclick_selector(CGridPageViewBackPackTest::onLayoutTouchEndedAfterLongClick));
	m_pLayout->setOnTouchCancelledAfterLongClickListener(this, afterlongclick_selector(CGridPageViewBackPackTest::onLayoutTouchEndedAfterLongClick));
