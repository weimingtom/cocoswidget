#include "TableGridViewTest.h"

void CTableGridViewTestSceneBase::onNextBtnClick(CCObject* pSender)
{
	nextCTableGridViewTestScene();
}

void CTableGridViewTestSceneBase::onBackBtnClick(CCObject* pSender)
{
	backCTableGridViewTestScene();
}

void CTableGridViewTestSceneBase::onRefBtnClick(CCObject* pSender)
{
	refCTableGridViewTestScene();
}

//////////////////////////////////////////////////////

bool CTableGridViewBasicTest::init()
{
	CTableGridViewTestSceneBase::init();
	setTitle("CTableGridViewBasicTest");
	...
	CTableGridView* pTable = CTableGridView::create(
		CCSizeMake(320, 390),
		CCSizeMake(320 / 4, 390 / 5),
		72, this, 
		tablegirdviewdatasource_selector(CTableGridViewBasicTest::tableviewDataSource));
	pTable->setColumns(4);
	pTable->setRows(5);
...
CTableGridViewCell* CTableGridViewBasicTest::tableviewDataSource(CTableGridView* pTable, CTableGridViewCell* pCell, unsigned int idx)
{
	CButton* pButton = NULL;

	if(!pCell)
	{
		pCell = new CTableGridViewCell();
		pCell->autorelease();
...
bool CTableGridViewBackPackTest::init()
{
	CTableGridViewTestSceneBase::init();
	setTitle("CTableGridViewBackPackTest");
	...
	pTable = CTableGridView::create(
		CCSizeMake(320, 390),
		CCSizeMake(320 / 4, 390 / 5),
		m_vData.size(), this, 
		tablegirdviewdatasource_selector(CTableGridViewBackPackTest::tableviewDataSource));
	pTable->setColumns(4);
	pTable->setRows(5);
	pTable->setAutoRelocate(true);
	pTable->setPosition(CCPoint(480, 320));
	...
	m_pLayout->setTouchMovedAfterLongClickSelector(this, afterlongclick_selector(CTableGridViewBackPackTest::onLayoutTouchMovedAfterLongClick));
	m_pLayout->setTouchEndedAfterLongClickSelector(this, afterlongclick_selector(CTableGridViewBackPackTest::onLayoutTouchEndedAfterLongClick));
	m_pLayout->setTouchCancelledAfterLongClickSelector(this, afterlongclick_selector(CTableGridViewBackPackTest::onLayoutTouchEndedAfterLongClick));
...
CTableGridViewCell* CTableGridViewBackPackTest::tableviewDataSource(CTableGridView* pTable, CTableGridViewCell* pCell, unsigned int idx)
{
	...
	if(!pCell)
	{
		...
		pIconButton->setLongClickSelector(this, longclick_selector(CTableGridViewBackPackTest::onItemLongClick));
...
bool CTableGridViewBackPackTest::onItemLongClick(CCObject* pSender)
{
...
void CTableGridViewBackPackTest::onLayoutTouchMovedAfterLongClick(CCObject* pSender, CCTouch* pTouch, float fDuration)
{
...
void CTableGridViewBackPackTest::onLayoutTouchEndedAfterLongClick(CCObject* pSender, CCTouch* pTouch, float fDuration)
{
	CButton* pIconButton = (CButton*) pSender;
